...
interface IPositionManager {
  ...
  /// @notice Returns the transfer guard address.
  /// @return The address of the transfer guard contract (address(0) if disabled)
  function transferGuard() external view returns (address);
